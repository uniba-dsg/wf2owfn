...
namespace WF2oWFN.Modules
{
    ...
    /// </summary>
    public class WriteLine : IPrimitive
    {
        // Logger
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);

        private readonly String name = "WriteLine";
        ...
        public PetriNet Compile(PetriNet phylum)
        {
            ...
            // Transitions
            Transition writeline = phylum.NewTransition(prefix + "writeline");
            // Arcs
            phylum.NewArc(p1, writeline);
            phylum.NewArc(writeline, p2);
